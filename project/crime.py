...
#Adjusting the probability cutoff to reflect the 8% crime rate
...
print "F1:", F1
""" recall = 87%, accuracy = 37%, cutoff is 0.05; recall = 54%, accuracy = 72%, cutoff =0.08; recall 41%, accuracy = 80%, cutoff is 0.1"
